...
def mock_animal_data():
    ...
    return {
        "animal": {
            ...
            "social_sharing": {
                "email_url": "http://example.com/adopt/buddy"
            }
        },
        "location": {
            "address": {
...
async def test_sanitize_animals():
    ...
    animals = [
        ...
        Animal(
            id=1, name="Buddy", breed="Lab", age="Young", sex="Male",
            location={}, description="", url="http://example.com",
        ...
        Animal(
            id=2, name="Max", breed="Poodle", age="Adult", sex="Male",
            location={}, description="", url="http://example.com",
            primary_photo="http://example.com/photo.jpg",
        ...
        Animal(
            id=3, name="Charlie", breed="Beagle", age="Senior", sex="Male",
            location={}, description="", url="http://example.com",
            primary_photo="",
            primary_photo_cropped="",
            photo_urls=[]
        ...
        Animal(
            id=4, name="Lucy", breed="Terrier", age="Young", sex="Female",
...
async def test_get_animal_signature():
    ...
    animal1 = Animal(
        id=1, name="Buddy", breed="Lab", age="", sex="",
        location={}, description="Good dog", url="",
        primary_photo="", primary_photo_cropped="", photo_urls=[]
    )
    
    animal2 = Animal(
        id=2, name="Buddy", breed="Lab", age="", sex="",
        location={}, description="Good dog", url="",
        primary_photo="", primary_photo_cropped="", photo_urls=[]
    )
    
    animal3 = Animal(
        id=3, name="Max", breed="Poodle", age="", sex="",
        location={}, description="Nice dog", url="",
        primary_photo="", primary_photo_cropped="", photo_urls=[]
    )
...
async def test_save_progress(tmp_path):
    ...
    scraper.collected_pets = [
        Animal(
            id=1, name="Buddy", breed="Lab", age="Young", sex="Male",
            location={"city": "Brooklyn"}, description="Good dog", url="http://example.com",
            primary_photo="http://example.com/photo.jpg",
            primary_photo_cropped="http://example.com/photo_cropped.jpg",
            photo_urls=[]
        ),
        ...
        Animal(
            id=2, name="Buddy", breed="Lab", age="Young", sex="Male",
            location={"city": "Brooklyn"}, description="Good dog", url="http://example.com",
            primary_photo="http://example.com/photo.jpg",
            primary_photo_cropped="http://example.com/photo_cropped.jpg",
            photo_urls=[]
        ...
        # Unique animal
        Animal(
            id=3, name="Max", breed="Poodle", age="Adult", sex="Male",
            location={"city": "Manhattan"}, description="Nice dog", url="http://example.com",
            primary_photo="http://example.com/photo.jpg",
            primary_photo_cropped="http://example.com/photo_cropped.jpg",
            photo_urls=[]
        )
...
async def test_scrape_all_pets(
    mock_save_progress, mock_process_batch, mock_fetch_page, mock_get_token, tmp_path
):
